export const foregroundColor = 'rgb(28, 30, 45)';
...
export const textDefaultColor = '#fff';
export const textColor = '#fff8';
...
export const textMonthFontWeight = 'bold';
...
export const arrowColor = 'rgb(173, 94, 223)';
